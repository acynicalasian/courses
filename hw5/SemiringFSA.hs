...
-- Corresponds to (8) on the handout from Wednesday
...
-- From (6) on the handout from Monday
...
-- From (3) on the handout from Wednesday
gfsa3 :: GenericAutomaton Int Char Double
gfsa3 = makeGFSA 0 ([1,2,3], ['C','V'],
                    [(1, 1.0)], 
                    [(1, 0.1)], 
                    [((1,'V',1), 0.2),
                     ((1,'C',2), 0.5),
...
-- From (15) on the handout from Wednesday
gfsa15 :: GenericAutomaton Int Char Cost
gfsa15 = makeGFSA Inf ([1,2,3], ['C','V'],
...
-- From (5) on the handout from Monday
